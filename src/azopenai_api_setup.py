...
if __name__ == "__main__":
    ...
    parser.add_argument("--api-url", type=str, default="https://aze-openai-03.openai.azure.com/")
    parser.add_argument("--api-version", type=str, default="2023-07-01-preview")
    args = parser.parse_args() 
    
    # setup Azure OpenAI
    setupAzureOpenAI(args.api_url, args.api_version)
